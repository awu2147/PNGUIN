...
namespace PNGUIN
{
    public static class PNGUtils
    {
        ...
        public static ushort ParseUshort(byte[] buffer, ref int offset)
        {
            ...
            {
                throw new ArgumentException($"buffer is not long enough to extract {sizeof(ushort)} bytes at offset {offset}");
            }
        ...
        public static uint ParseUint(byte[] buffer, ref int offset)
        {
            ...
            {
                throw new ArgumentException($"buffer is not long enough to extract {sizeof(uint)} bytes at offset {offset}");
            }
